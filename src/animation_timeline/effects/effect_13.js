...
export default function geteffect(cubic_ease) {
  // console.log(cubic_ease)
  // const defaultEase = CustomEase.create("custom", "M0,0 C0.015,0.3 0.161,0.576 0.319,0.724 0.511,0.904 0.818,1.001 1,1 ");
  // const defaultEase = CustomEase.create("custom", "M0,0 C0.015,0.3 0.042,0.525 0.204,0.67 0.388,0.834 0.818,1.001 1,1 ");
  const defaultEase = CustomEase.create("custom", "M0,0 C0.015,0.3 0,0.44 0.16,0.585 0.344,0.749 0.818,1.001 1,1 ");
  const appliedEase = defaultEase;
  return {
    ...default_config,
    glow_ease: ease,
    glow_delay: 0,
    ...
    back_plane_ripple_wave_duration: 4,
    // back_plane_ripple_wave_ease: "none",
    back_plane_ripple_wave_ease: appliedEase,
    back_plane_ripple_wave_timeline: "start+=2.15",

    back_plane_ripple_wave_factor_duration: 1.,
    // back_plane_ripple_wave_factor_ease: CustomEase.create("custom", "M0,0 C0.029,0.206 -0.043,0.717 0.114,0.865 0.305,1.044 0.818,1.001 1,1 "),
    back_plane_ripple_wave_factor_ease: "none",
    back_plane_ripple_wave_factor_timeline: "start+=2.5",
