...
export default {
  ...
  back_plane_ripple_wave_ease: CustomEase.create("custom", "M0,0 C0.042,0.308 0.068,0.451 0.225,0.599 0.417,0.779 0.693,1 1,1 "),
  // back_plane_ripple_wave_ease: "none",
  back_plane_ripple_wave_timeline: "start+=2.45",
