...
const back_fragment = [fragment_back_1, fragment_back_2, fragment_back_3, fragment_back_4, fragment_back_5]
const front_fragment = [fragment_front_1, fragment_front_2, fragment_front_3, fragment_front_4, fragment_front_5]
